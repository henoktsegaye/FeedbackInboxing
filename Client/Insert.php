...
<div class="col s6"  >
    ...
    <form class="col card s12 z-depth-0"   action="InsertController.php" method="post" 
...
<div class="row">
	...
	<input type="submit" class="btn btn-default btn-large cyan pulse" name="submit" value="GO">
	<br>
	<br>
</div>
	</form>
